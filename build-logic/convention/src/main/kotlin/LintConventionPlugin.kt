    ...
    with(target) {
      when {
        pluginManager.hasPlugin("com.android.application") ->
          extensions.configure<ApplicationExtension> { lint.configureLint(target) }
        /*
        extensions.configure<ApplicationExtension> { lint(Lint::configure) }
        */
        pluginManager.hasPlugin("com.android.library") ->
          extensions.configure<LibraryExtension> { lint.configureLint(target) }
        /*
...
/** Extension Function, die das Project-Objekt mitnimmt, um auf Pfade und Utilities zuzugreifen. */
