    ...
    Column(
        ...
        AnimatedContent(
            ...
            when (tabs[tabIndex]) {
                ...
                DrawerTab.TERMINAL -> {
                    TerminalTabContent(
                        onOpenTerminalSheet = onOpenTerminalSheet
                    )
                }
            }
        }
...
@Composable
private fun BuildVariantsTabContent(
    modifier: Modifier = Modifier
) {
...
@Composable
private fun SubModuleMakerTabContent(
    modifier: Modifier = Modifier
) {
...
@Composable
private fun AssetStudioTabContent(
    modifier: Modifier = Modifier
) {
    Column(
        modifier = modifier
        ...
        AssetQuickAction(
            title = "Create Icon",
            description = "Launcher or action icon",
            onClick = { }
        )
        
        AssetQuickAction(
            title = "Import Image",
            description = "From gallery or file",
            onClick = { }
        )
    }
}
