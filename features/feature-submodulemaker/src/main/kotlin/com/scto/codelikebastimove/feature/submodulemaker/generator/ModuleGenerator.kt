...
object ModuleGenerator {
    ...
    fun generateModule(
        ...
        updateSettingsGradle(projectRoot, config.gradlePath)
    }
 ...
 */
object ${config.moduleName.toPascalCase()}Module {
    const val MODULE_NAME = "${config.moduleName}"
}
"""
        File(srcDir, "${config.moduleName.toPascalCase()}Module.kt").writeText(content)
    }
