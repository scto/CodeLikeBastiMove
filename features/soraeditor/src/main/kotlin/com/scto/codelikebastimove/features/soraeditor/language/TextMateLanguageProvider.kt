...
class TextMateLanguageProvider : LanguageProvider {
    ...
    private fun loadThemes() {
        ...
        try {
            val darkTheme = ThemeModel(
                IThemeSource.fromInputStream(
                    FileProviderRegistry.getInstance().tryGetInputStream("textmate/themes/dark_modern.json"),
            ...
            val lightTheme = ThemeModel(
                IThemeSource.fromInputStream(
                    FileProviderRegistry.getInstance().tryGetInputStream("textmate/themes/light_modern.json"),
