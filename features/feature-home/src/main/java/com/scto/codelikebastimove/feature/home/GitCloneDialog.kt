...
import com.scto.codelikebastimove.core.datastore.GitConfig
                    ...
                    Button(
                        onClick = {
                            ...
                            scope.launch {
                                ...
                                gitConfigured = true
                                currentStep = if (credentialsConfigured) {
                                    CloneDialogStep.CLONE_OPTIONS
                                } else {
                                    CloneDialogStep.CREDENTIALS
                                }
...
private suspend fun cloneRepository(
    ...
    try {
        ...
        val processBuilder = ProcessBuilder(cloneCommand)
        ...
        if (cloneSubmodules) {
            ...
            val submoduleProcess = ProcessBuilder(
...
private suspend fun addSafeDirectory(path: String) = withContext(Dispatchers.IO) {
    try {
