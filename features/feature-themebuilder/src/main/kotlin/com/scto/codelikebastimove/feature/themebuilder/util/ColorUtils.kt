...
fun rgbToHsl(r: Float, g: Float, b: Float): Triple<Float, Float, Float> {
    ...
    val saturation = if (max == min) 0f else {
...
val availableFonts = listOf(
    "-- System Default --", "Roboto", "Inter", "Open Sans",
    "Montserrat", "Poppins", "Lato", "Noto Sans", "Source Sans Pro"
)

val schemeOptions = listOf(
    "Tonal Spot", "Neutral", "Vibrant", "Expressive",
    "Fidelity", "Content", "Monochromatic", "Rainbow", "Fruit Salad"
)

fun getSchemeDescription(scheme: String): String = when (scheme) {
