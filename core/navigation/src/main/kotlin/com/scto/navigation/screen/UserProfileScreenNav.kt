...
import com.scto.user.profile.di.featureUserProfileModule
import com.scto.user.profile.view.ProfileScreen
import com.scto.user.profile.view.vm.ProfileViewModel
    ...
    composable(
        ...
        ProfileScreen(
            ...
            onAnalyticsSwitched = { isEnabled ->
                viewModel.onAnalyticsSwitched(isEnabled)
            },
