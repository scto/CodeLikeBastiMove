 ...
 * @see <a href="https://github.com/JetBrains/intellij-community/blob/master/platform/util/base/src/com/intellij/filename/UniqueNameBuilder.java">UniqueNameBuilder.java</a>
 *
 * @param <T> Der Typ des Schlüssels (meistens der Pfad oder ein File-Objekt).
 */
class UniqueNameBuilder<T>(
     ...
     * /idea/fabrique/download/index.html
     *
     * [RootNode] <- [/index.html] <- [/download] <- [/pycharm] <- [/idea]
     * <- [/fabrique] <- [/idea]
     */
