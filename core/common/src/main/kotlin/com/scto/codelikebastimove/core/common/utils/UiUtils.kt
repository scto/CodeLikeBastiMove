...
/**
 * Composable-Helper, um festzustellen, ob die UI gerade im Dark Mode gerendert werden soll. Wrapper
 * um [isSystemInDarkTheme].
 *
 * Nutzung in Compose: if (isAppInDarkTheme()) { ... }
 */
@Composable
@ReadOnlyComposable
...
/**
 * Prüft anhand des [Context], ob die App gerade im Dark Mode läuft. Nützlich für Logik außerhalb
 * von @Composable-Funktionen (z.B. Analytics, Services).
 *
