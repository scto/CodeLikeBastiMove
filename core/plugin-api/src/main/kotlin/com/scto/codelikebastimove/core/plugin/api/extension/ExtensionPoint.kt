...
interface ToolWindowProvider : Extension {
    val icon: String? get() = null
    val position: ToolWindowPosition get() = ToolWindowPosition.BOTTOM
...
interface ProjectWizardExtension : Extension {
    ...
    val templateIcon: String? get() = null
...
enum class WizardFieldType {
    TEXT, NUMBER, BOOLEAN, SELECT, MULTI_SELECT, FILE_PATH, DIRECTORY_PATH
}
...
interface BackgroundTask : Extension {
    val intervalMs: Long get() = 60000L
    val runOnStartup: Boolean get() = false
