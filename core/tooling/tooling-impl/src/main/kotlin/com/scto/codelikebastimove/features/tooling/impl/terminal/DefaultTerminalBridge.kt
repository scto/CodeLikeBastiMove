...
class DefaultTerminalBridge(
    ...
    private val environment = mutableMapOf<String, String>().apply {
    ...
    override suspend fun connect(): Result<Unit> = withContext(Dispatchers.IO) {
        runCatching {
            ...
            val client = TermuxTerminalSessionClientAdapter(
    ...
    override suspend fun setEnvironmentVariable(key: String, value: String): Result<Unit> = runCatching {
