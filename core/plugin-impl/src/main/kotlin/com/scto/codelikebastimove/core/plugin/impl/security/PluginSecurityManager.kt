...
class PluginSecurityManager {
    ...
    fun checkCompatibility(descriptor: PluginDescriptor, hostVersion: String): CompatibilityResult {
        ...
        val maxVersionOk = descriptor.maxHostVersion?.let { maxVersion ->
        ...
        return CompatibilityResult(
            ...
            reason = when {
                !isCompatible -> "Host version $hostVersion is below minimum required ${descriptor.minHostVersion}"
                !maxVersionOk -> "Host version $hostVersion exceeds maximum supported ${descriptor.maxHostVersion}"
                else -> "Compatible"
            }
        )
    }
