...
class TermuxPreferences private constructor(context: Context) {
    ...
    companion object {
        ...
        @Volatile
        private var instance: TermuxPreferences? = null
    ...
    var bellBehaviour: String
        get() = preferences.getString(Keys.BELL_BEHAVIOUR, Defaults.BELL_BEHAVIOUR) ?: Defaults.BELL_BEHAVIOUR
    ...
    var backKeyBehaviour: String
        get() = preferences.getString(Keys.BACK_KEY_BEHAVIOUR, Defaults.BACK_KEY_BEHAVIOUR) ?: Defaults.BACK_KEY_BEHAVIOUR
        set(value) = preferences.edit().putString(Keys.BACK_KEY_BEHAVIOUR, value).apply()
    
    var terminalCursorKeys: String
        get() = preferences.getString(Keys.TERMINAL_CURSOR_KEYS, Defaults.TERMINAL_CURSOR_KEYS) ?: Defaults.TERMINAL_CURSOR_KEYS
