...
data class ExecutionCommand(
  ...
  fun hasExecuted(): Boolean =
    currentState == State.EXECUTED || currentState == State.SUCCESS || currentState == State.FAILED

  fun isSuccessful(): Boolean = currentState == State.SUCCESS || (hasExecuted() && exitCode == 0)
  ...
  companion object {
    fun createEmpty(): ExecutionCommand =
      ExecutionCommand(
        id = 0,
        executable = null,
        arguments = null,
