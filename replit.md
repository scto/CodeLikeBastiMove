...
- **Home Module (`feature/home`):** Dedicated module for home screen, project creation wizard, import projects, and project list management. Contains HomeViewModel for project-related operations (create, delete, open, clone, import) and HomeScreen, CreateProjectScreen, ImportProjectScreen, OpenProjectScreen UI components. **Project Persistence:** HomeViewModel scans CLBMProjects directory on startup and syncs discovered projects with DataStore, ensuring projects persist across app reinstalls.
