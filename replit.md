...
- **Tree View (`features/feature-treeview`):** File tree view component with AndroidIDE-inspired dark design, featuring brownish folder icons, animated chevron expand/collapse indicators, project header with settings and new folder buttons, and support for hidden files display.
