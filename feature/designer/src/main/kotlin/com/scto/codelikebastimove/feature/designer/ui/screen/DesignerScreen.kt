...
fun DesignerScreen(
  ...
  LaunchedEffect(uiState.exportSuccess) {
    uiState.exportSuccess?.let { success ->
      snackbarHostState.showSnackbar(if (success) "Export successful!" else "Export failed")
    }
  }
  ...
  Scaffold(
      ...
      TopAppBar(
        ...
        actions = {
          IconButton(onClick = { viewModel.showThemeSelector() }) {
            Icon(imageVector = Icons.Default.ColorLens, contentDescription = "Theme")
          }
          IconButton(onClick = { viewModel.togglePreview() }) {
            Icon(imageVector = Icons.Default.Preview, contentDescription = "Preview")
          }
          IconButton(onClick = { viewModel.showCodeDialog() }) {
            Icon(imageVector = Icons.Default.Code, contentDescription = "View Code")
          }
    ...
    Row(modifier = Modifier.fillMaxSize().padding(paddingValues)) {
      PalettePanel(
        onBlockSelected = { blockType -> viewModel.addBlock(blockType, Offset(100f, 100f)) },
      ...
      PropertyInspector(
        ...
        onPropertyChanged = { key, value -> viewModel.updateBlockProperty(key, value) },
        onBlockDeleted = { uiState.selectedBlockId?.let { viewModel.deleteBlock(it) } },
      )
    }
  }
        ...
        if (validation != null) {
          Row(
            ...
            if (validation.isValid) {
              ...
              Text(text = "Syntax valid", color = MaterialTheme.colorScheme.primary)
            } else {
              Icon(
          ...
          if (exportDirectoryUri != null) {
            Card(
              ...
              Row(
                ...
                TextButton(onClick = onPickDirectory) { Text("Change") }
              }
            }
          } else {
        ...
        Column(modifier = Modifier.padding(16.dp)) {
          ...
          Row(modifier = Modifier.fillMaxWidth(), verticalAlignment = Alignment.CenterVertically) {
            Checkbox(
              ...
              onCheckedChange = { onConfigChanged(exportConfig.copy(includeImports = it)) },
            )
          ...
          Row(modifier = Modifier.fillMaxWidth(), verticalAlignment = Alignment.CenterVertically) {
            Checkbox(
              ...
              onCheckedChange = { onConfigChanged(exportConfig.copy(formatCode = it)) },
            )
            Text("Format code")
          }
          ...
          Row(modifier = Modifier.fillMaxWidth(), verticalAlignment = Alignment.CenterVertically) {
            Checkbox(
              ...
              onCheckedChange = { onConfigChanged(exportConfig.copy(validateSyntax = it)) },
            )
        ...
        Card(
          ...
          Column(modifier = Modifier.padding(16.dp)) {
            ...
            OutlinedTextField(
              ...
              onValueChange = { onConfigChanged(exportConfig.copy(themeName = it)) },
            ...
            Row(
              ...
              Checkbox(
                ...
                onCheckedChange = { onConfigChanged(exportConfig.copy(exportThemeToRepo = it)) },
              )
            ...
            if (exportConfig.exportThemeToRepo) {
              OutlinedTextField(
                ...
                onValueChange = { onConfigChanged(exportConfig.copy(themeRepoName = it)) },
              ...
              OutlinedTextField(
                ...
                onValueChange = { onConfigChanged(exportConfig.copy(themeRepoDescription = it)) },
      ...
      Card(
        ...
        Column(modifier = Modifier.padding(16.dp)) {
          ...
          OutlinedTextField(
            ...
            onValueChange = { onConfigChanged(exportConfig.copy(componentPrefix = it)) },
            label = { Text("Prefix") },
            placeholder = { Text("e.g., MyApp") },
            modifier = Modifier.fillMaxWidth(),
            singleLine = true,
            supportingText = { Text("Custom components will be prefixed (e.g., MyAppButton)") },
          )
        }
      }
      ...
      Column {
        Card(
          ...
          Row(modifier = Modifier.padding(16.dp), verticalAlignment = Alignment.CenterVertically) {
            ...
            Column {
              Text(text = "Default Theme", fontWeight = FontWeight.Medium)
              Text(
        ...
        themes.forEach { theme ->
          Card(
            ...
            Row(
              ...
              Spacer(modifier = Modifier.width(12.dp))
              Column {
                Text(text = theme.name, fontWeight = FontWeight.Medium)
