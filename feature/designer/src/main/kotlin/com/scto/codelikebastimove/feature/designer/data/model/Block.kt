    ...
    fun getDefaultProperties(type: BlockType): Map<String, BlockProperty> {
      val common =
        mutableMapOf(
          ...
          "contentDescription" to
            BlockProperty("contentDescription", "Content Description", PropertyType.STRING, null),
        )
      ...
      when (type) {
        BlockType.TEXT -> {
          ...
          common["fontSize"] =
            BlockProperty("fontSize", "Font Size", PropertyType.DIMENSION, "16.sp")
          common["fontWeight"] =
            BlockProperty("fontWeight", "Font Weight", PropertyType.FONT_WEIGHT, "Normal")
          common["color"] = BlockProperty("color", "Color", PropertyType.COLOR, null)
          common["textAlign"] =
            BlockProperty("textAlign", "Text Align", PropertyType.TEXT_ALIGN, "Start")
        }
        BlockType.BUTTON,
        BlockType.OUTLINED_BUTTON,
        BlockType.TEXT_BUTTON -> {
        ...
        BlockType.OUTLINED_TEXT_FIELD -> {
          ...
          common["placeholder"] =
            BlockProperty("placeholder", "Placeholder", PropertyType.STRING, "")
          common["singleLine"] =
            BlockProperty("singleLine", "Single Line", PropertyType.BOOLEAN, true)
        }
        BlockType.COLUMN -> {
          common["verticalArrangement"] =
            BlockProperty(
              "verticalArrangement",
        ...
        BlockType.CHECKBOX,
        BlockType.RADIO_BUTTON -> {
          common["checked"] = BlockProperty("checked", "Checked", PropertyType.BOOLEAN, false)
          common["enabled"] = BlockProperty("enabled", "Enabled", PropertyType.BOOLEAN, true)
        }
        BlockType.TOP_APP_BAR -> {
          common["title"] = BlockProperty("title", "Title", PropertyType.STRING, "Title")
          common["navigationIcon"] =
            BlockProperty("navigationIcon", "Navigation Icon", PropertyType.BOOLEAN, true)
        }
        else -> {}
      }
