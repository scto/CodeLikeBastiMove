    ...
    Column(
      ...
      ModuleConfigurationCard(
        ...
        onCreateClick = {
          ...
          val config =
            ModuleConfig(gradlePath = gradlePath, language = selectedLanguage, packageName = "")
  ...
  Surface(
    ...
    Column(modifier = Modifier.padding(20.dp), verticalArrangement = Arrangement.spacedBy(20.dp)) {
      ...
      OutlinedTextField(
        ...
        modifier = Modifier.fillMaxWidth(),
        placeholder = {
          Text("Enter folder path (e.g., features, core/ui)", color = SubModuleSecondaryText)
        },
        leadingIcon = {
          Icon(Icons.Default.Extension, contentDescription = null, tint = SubModuleSecondaryText)
        },
        colors =
      ...
      OutlinedTextField(
        ...
        modifier = Modifier.fillMaxWidth(),
        placeholder = {
          Text("Enter module name (e.g., login, network)", color = SubModuleSecondaryText)
        },
        leadingIcon = {
          Icon(Icons.Default.Extension, contentDescription = null, tint = SubModuleSecondaryText)
        },
...
private fun AboutCard(modifier: Modifier = Modifier) {
  Surface(
    ...
    Column(modifier = Modifier.padding(20.dp)) {
      ...
      Text(
        text =
          "Sub-modules help organize your project into smaller, manageable components. Each module can have its own dependencies and build configuration.",
        style = MaterialTheme.typography.bodyMedium,
        color = SubModuleSecondaryText,
      )
