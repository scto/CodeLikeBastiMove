...
data class TokenColorRule(val scope: List<String>, val settings: TokenColorSettings)
...
abstract class AbstractEditorThemePlugin : EditorThemePlugin {
  override val description: String
    get() = "Editor theme: $themeName"

  override val priority: Int
    get() = 0

  protected abstract fun createThemeDefinition(): EditorThemeDefinition

  override val previewColors: EditorThemePreview
    get() {
      val definition = createThemeDefinition()
      return EditorThemePreview(
        background = definition.colors.editorBackground,
        foreground = definition.colors.editorForeground,
        accent = definition.colors.editorSelection,
        selection = definition.colors.editorSelection,
      )
    }

  override fun getThemeDefinition(): EditorThemeDefinition = createThemeDefinition()
