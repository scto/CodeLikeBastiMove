  ...
  override fun getActionContributions(): List<EditorActionContribution> {
    return getEditorActions().map { action ->
      EditorActionContribution(
        ...
        menuContributions =
          action.menuLocations.map { menuId ->
            MenuContribution(actionId = action.id, menuId = menuId, order = action.priority)
          },
        condition = action.whenCondition,
      )
    }
  }
...
object BuiltinEditorActions {
  fun createUndoAction(): EditorPluginAction =
    EditorPluginAction(
  ...
  fun createRedoAction(): EditorPluginAction =
    EditorPluginAction(
  ...
  fun createCutAction(): EditorPluginAction =
    EditorPluginAction(
  ...
  fun createCopyAction(): EditorPluginAction =
    EditorPluginAction(
  ...
  fun createPasteAction(): EditorPluginAction =
    EditorPluginAction(
  ...
  fun createSelectAllAction(): EditorPluginAction =
    EditorPluginAction(
  ...
  fun createFindAction(): EditorPluginAction =
    EditorPluginAction(
  ...
  fun createReplaceAction(): EditorPluginAction =
    EditorPluginAction(
  ...
  fun createFormatDocumentAction(): EditorPluginAction =
    EditorPluginAction(
  ...
  fun createCommentLineAction(): EditorPluginAction =
    EditorPluginAction(
  ...
  fun createGoToLineAction(): EditorPluginAction =
    EditorPluginAction(
  ...
  fun getAllBuiltinActions(): List<EditorPluginAction> =
    listOf(
      createUndoAction(),
      createRedoAction(),
      createCutAction(),
