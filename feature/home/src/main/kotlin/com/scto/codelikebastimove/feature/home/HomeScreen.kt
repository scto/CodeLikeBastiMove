...
fun HomeScreen(
  ...
  Column(
    ...
    HomeButton(icon = Icons.Default.FolderOpen, text = "Öffne ein Projekt", onClick = {})
    ...
    HomeButton(icon = Icons.Default.Help, text = "Hilfe", onClick = {})

    Spacer(modifier = Modifier.height(16.dp))

    HomeButton(icon = Icons.Default.QuestionAnswer, text = "FAQ", onClick = {})
  }
...
@Composable
private fun HomeButton(icon: ImageVector, text: String, onClick: () -> Unit) {
  Button(
    onClick = onClick,
