...
@Composable
fun EditorContent(viewModel: MainViewModel, modifier: Modifier = Modifier) {
    ...
    if (openFiles.isNotEmpty()) {
      ...
      if (uiState.isLoading) {
        ...
        if (activeFile != null) {
          SoraCodeEditorArea(
            file = activeFile,
            onContentChange = { newContent -> viewModel.updateFileContent(newContent) },
        ...
        Tab(
          ...
          Row(
            ...
            Text(
              ...
              color =
                if (file.isModified) MaterialTheme.colorScheme.primary
                else MaterialTheme.colorScheme.onSurface,
            )

            IconButton(onClick = { onTabClose(index) }, modifier = Modifier.size(16.dp)) {
              Icon(
