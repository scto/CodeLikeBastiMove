...
private fun StatusIndicators(modifier: Modifier = Modifier) {
  Row(
    ...
    Row(
      ...
      Text(text = "0", fontSize = 11.sp, color = MaterialTheme.colorScheme.error)
    }
    ...
    Row(
      ...
      Text(text = "0", fontSize = 11.sp, color = MaterialTheme.colorScheme.tertiary)
    }
  }
}

@Composable
private fun BottomSheetContent(contentType: BottomSheetContentType, modifier: Modifier = Modifier) {
