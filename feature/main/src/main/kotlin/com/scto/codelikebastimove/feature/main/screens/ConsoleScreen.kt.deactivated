...
@Composable
fun ConsoleScreen(onBackClick: () -> Unit, modifier: Modifier = Modifier) {
...
tiMove ${'$'} 
  ...
  Scaffold(
    ...
    Column(modifier = Modifier.fillMaxSize().background(Color(0xFF1E1E1E)).padding(paddingValues)) {
      Box(
        modifier =
          Modifier.weight(1f)
            .fillMaxWidth()
...
@Composable
private fun TerminalKeyboardBar(modifier: Modifier = Modifier) {
...
@Composable
private fun TerminalKey(text: String, modifier: Modifier = Modifier) {
  Surface(
    onClick = {},
