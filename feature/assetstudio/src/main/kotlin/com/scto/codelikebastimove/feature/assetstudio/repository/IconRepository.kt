...
class MaterialIconsRepository : IconRepositoryProvider {
  ...
  override suspend fun searchIcons(
    query: String,
    category: String?,
    style: IconStyle?,
    page: Int,
  ...
  private fun buildFeatherIconsList(): List<VectorAsset> {
    return listOf(
      VectorAsset(
        ...
        "Arrow Left",
        "Arrows",
        listOf("back", "previous"),
        provider = IconProvider.FEATHER_ICONS,
      ),
      VectorAsset(
        "feather_arrow_right",
        "Arrow Right",
